...
def convert_value(value, config_value):
    ...
    if config_value.val_type == bool:
        return convert_to_bool(value)
    else:
        return config_value.val_type(value)
...
class ConfigValue(object):
    def __init__(self, name, default_value = None, val_type = str):
        ...
        if type(self.default_value) != self.val_type:
            self.default_value = convert_value(self.default_value, self)
